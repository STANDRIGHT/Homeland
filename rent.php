...
if(isset($_GET["id"])){
    ...
    $query = $conn->query("SELECT * FROM props WHERE _type='$id'");
    $query->execute();
        ...
        <div class="site-blocks-cover overlay" style="background-image: url(images/<?php echo $prop->image; ?>);"
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center text-center">
                    <div class="col-md-10">
                        <span
                            class="d-inline-block bg-<?php if ($prop->_type == "rent") {
                                echo "success";
                            } else {
                                echo "danger";
                            } ?> text-white px-3 mb-3 property-offer-type rounded"><?php echo $prop->_type; ?> </span>
                        <h1 class="mb-2">
                            <?php echo $prop->name; ?>
                        </h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
                    <div class="mr-auto">
                        <a href="<?php 'BASEURL' ?>" class="icon-view view-module active"><span
                    ...
                    <div class="property-entry h-100">
                        <a href="property-details.php?id=<?php echo $prop->id; ?>" class="property-thumbnail">
                            <div class="offer-type-wrap">
                                <span
                                    class="offer-type bg-<?php if ($prop->_type == "rent") {
                                        echo "success";
                                    } else {
                                        echo "danger";
                                    } ?>"><?php echo $prop->_type; ?></span>
                            </div>
