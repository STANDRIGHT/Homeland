              ...
              <div class="property-entry h-100">
                <a href="property-details.php?id=<?php echo $property->RPid ?>" class="property-thumbnail">
                  <div class="offer-type-wrap">
                    <span class="offer-type bg-<?php if($property->RPtypes=="sale"){echo "success";}elseif($property->RPtypes=="Lease"){ echo "info";}else{echo "danger";} ?>"><?php echo $property->RPtypes; ?></span>
                  </div>
